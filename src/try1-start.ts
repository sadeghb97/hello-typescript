...
tsc --init --> in project directory
git init
npm init
*/

/*
file haye ts mostaghim dar morurgar ejra nakhahand shod. file haye tse ma ba compilere
typescript ebteda be js tabdil mishavand va sepas ma file bundle shode ra dar morurgar import mikonim
tanzimate compile typescript darune tsconfig gharar darad.
